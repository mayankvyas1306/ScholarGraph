    ...
    <div className="rp-root fade-in">
      ...
      <div className="rp-paper">
        ...
        <div className="rp-footer">
          ...
          {/* Was hardcoded to "LLM: Claude", but the configured provider
              (backend/clients/llm_provider.py) defaults to Gemini first,
              then falls back to Anthropic/OpenAI — so a static vendor name
              here was frequently wrong. Kept generic instead of trying to
              surface the actual provider, since results/state don't
              currently carry that info to the frontend. */}
          <span>Sources: arXiv.org · Semantic Scholar · AI-assisted synthesis</span>
        </div>
