...
export default function ReportExport({ jobId, results }) {
  ...
  const handleDownload = async (format) => {
    ...
    try {
      ...
      a.href     = url;
      a.download = `ScholarGraph_Report_${String(jobId).slice(0, 8)}.${format}`;
    ...
    <div className="rp-root fade-in">
      ...
      <div className="rp-paper">
        ...
        <div className="rp-footer">
          <span>Generated by ScholarGraph · {new Date().toLocaleDateString('en-US', { year: 'numeric', month: 'long', day: 'numeric' })}</span>
